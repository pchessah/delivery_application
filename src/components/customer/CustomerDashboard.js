    ...
    <div className="mainDivCustomerDashboard">
      ...
      <div className="customerDashboard">
        <section className="pickupsection">
          ...
          <Link to="/">
            <div>
              <img style={{borderRadius: "3rem"}} className="img-fluid" src="https://images.pexels.com/photos/38271/ipad-map-tablet-internet-38271.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940" alt="delivery" />
            </div>
          </Link>
        ...
        <section className="vendorsection">
          ...
          <Link to="/">
            <div>
              <img style={{borderRadius: "3rem"}}className="img-fluid" src="https://images.pexels.com/photos/1036857/pexels-photo-1036857.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500" alt="vendor"/>
            </div>
          </Link>
          <section style={{ marginTop: "6.5rem" }}>
            <ul style={{fontSize: "1.3rem"}}>
